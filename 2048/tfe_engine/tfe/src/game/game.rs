...
impl Game {
    pub fn new(algorithm: RandomWeightsAlgorithm) -> Game {
    ...
    pub fn resume(&mut self, mut algorithm: RandomWeightsAlgorithm) {
...
mod tests {
    ...
    #[test]
    fn test_get_boards(){
        let game: Game = Game::new(RandomWeightsAlgorithm::new());
    ...
    fn test_resume_game_when_there_are_no_possible_movements() {
        ...
        game.resume(RandomWeightsAlgorithm::new());

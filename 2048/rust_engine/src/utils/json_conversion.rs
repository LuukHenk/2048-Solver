...
pub fn convert_games_data_to_json(games: Vec<Game>) -> String {
    ...
    for game_index in 0 .. games.len() {
        ...
        games_data_json.push(
            convert_dataset_to_json_data_format(game_states, JsonDataFormats::List)
        );
    }
...
fn convert_dataset_to_json_data_format(dataset: Vec<String>, data_format: JsonDataFormats) -> String {
